...
const cards: CollageCard[] = [
  {
    ...
    rotate: -8,
    description:
      "너에게 음악은 배경이 아니라 몸을 통과하는 사고다. 밴드 연주를 하고 리듬으로 기억을 붙잡는 너에게 이 앨범은 생각보다 먼저 도착하는 그루브의 원형처럼 남아 있다. 어떤 밤에는 글보다 베이스라인이 너를 더 정확하게 설명한다.",
  },
  {
    ...
    rotate: 6,
    description:
      "네가 좋아하는 음악에는 늘 사적인 잔광이 있다. 이 커버는 감정이 장르보다 오래 남는다는 사실, 그리고 어떤 사운드는 네 블로그의 문장들처럼 뒤늦게 감정을 드러낸다는 사실을 상기시킨다.",
  },
  {
    ...
    rotate: -7,
    description:
      "너의 취향이 늘 선명한 멜로디만 향하는 것은 아니다. 이 앨범은 말해지지 않은 감정이 노이즈 속에 오래 눌려 남는 방식을 닮아 있고, 그래서 네가 직접 쓰지 못한 어떤 것들을 대신 울려주는 장면처럼 보인다.",
  },
  {
    ...
    rotate: 7,
    description:
      "네 연구가 광자와 회로, 변조와 구조를 다룬다고 해서 미래를 무채색으로 상상할 필요는 없다. 네가 좋아하는 미래는 이런 식으로 조금 과장되고 찬란하다. 기술이 계산이 아니라 희열의 디자인이 되는 장면이 여기 있다.",
  },
  {
    ...
    rotate: -5,
    description:
      "재즈는 네 취향에서 하나의 윤리처럼 보인다. 과잉보다 간격, 과시보다 호흡, 그리고 계산된 망설임. 너는 이런 음악을 들을 때 연구에서도 글쓰기에서도 결국 중요한 것은 밀도가 아니라 배치라는 사실을 다시 확인하게 된다.",
  },
  {
    ...
    rotate: 5,
    description:
      "네 블로그 글들을 읽고 있으면 감상이 자주 에세이를 넘어 미로가 된다. 보르헤스는 그 미로의 가장 정확한 선조다. 너에게 이 책은 단순한 취향이 아니라 독서가 어떻게 사유의 구조가 되는지를 알려준 텍스트에 가깝다.",
  },
  {
    ...
    rotate: -8,
    description:
      "너는 읽는 행위 자체를 다시 쓰고 싶어 하는 사람처럼 보인다. 칼비노는 바로 그 충동의 소설가다. 책을 읽는 사람이 이야기의 바깥이 아니라 내부의 장치가 되는 방식은, 네 글이 종종 독서 경험 자체를 주제로 삼는 이유와도 닿아 있다.",
  },
  {
    ...
    rotate: 7,
    description:
      "네가 좋아하는 텍스트에는 늘 청춘의 폐허가 조금씩 남아 있다. 완성된 세계보다 도주 중인 세계, 정리된 문학사보다 사라진 이름들의 흔적. 볼라뇨는 네가 책에서 찾는 그 불완전한 열기를 가장 잘 대변하는 작가 중 하나다.",
  },
  {
    ...
    rotate: -6,
    description:
      "네가 이 영화를 좋아한다면 그것은 폭력 때문이 아니라 분열된 자아가 만들어내는 이상한 미학 때문일 것이다. 네 글에도 가끔 그런 긴장이 있다. 세련된 표면 아래에서 정체성과 욕망이 서로를 밀어내는 방식 말이다.",
  },
  {
    ...
    rotate: 6,
    description:
      "너는 서사의 내용만큼 편집의 리듬에도 끌리는 사람 같다. 펄프 픽션은 시간의 순서를 비틀어 장면들을 더 강하게 기억하게 만들고, 그런 배치 감각은 네가 음악과 글을 한 화면에 겹쳐두고 싶어 하는 취향과도 자연스럽게 이어진다.",
  },
  {
    ...
    rotate: 2,
    description:
      "이 초상은 그냥 네 사진이 아니라 음악을 하고 글을 쓰고 연구를 하는 여러 버전의 네가 한 장에 겹쳐진 장면처럼 보인다. 얼굴은 하나지만 그 안에는 무대 위의 너와 책상 앞의 너, 실험실의 너가 동시에 반사된다.",
  },
  {
    ...
    fit: "contain",
    description:
      "KAIST는 네게 단순한 소속이 아니라 질문의 형식을 바꿔놓은 장소일 것이다. 음악과 글이 감정의 밀도를 다루는 동안, 여기서는 빛과 물질, 구조와 측정이 다른 문법으로 같은 집요함을 요구한다.",
  },
  {
    ...
    fit: "contain",
    description:
      "다이아몬드는 네 연구에서 더 이상 장식이 아니다. 오히려 결함을 품은 채 광자와 스핀을 이어주는 플랫폼이고, 그래서 너에게 아름다움은 완벽한 표면보다 제어 가능한 불완전성에 더 가까워진다.",
  },
  {
    ...
    fit: "contain",
    description:
      "BTO를 보는 네 시선에는 재료공학적 호기심과 회로적 감각이 함께 있다. 너에게 변조는 단순한 기능이 아니라 물질이 빛의 문장을 얼마나 섬세하게 고쳐 쓸 수 있는지를 보여주는 장면일 것이다.",
  },
  {
    ...
    fit: "contain",
    description:
      "역설계는 네 연구가 손으로만 그려지는 것이 아니라는 사실을 보여준다. 직관은 여기서 사라지지 않고 계산을 통과한 뒤 다른 형태의 직관으로 돌아온다. 너는 아마 이런 장면에서 공학이 미학과 만나는 지점을 본다.",
  },
  {
    ...
    fit: "contain",
    description:
      "이 구조들은 네게 figure가 아니라 지형도에 가깝다. 구멍과 선, 공진과 손실을 읽어가며 너는 결과를 본다기보다 가능성의 지도를 해독한다. 연구가 네게 매력적인 이유도 아마 바로 그런 독해의 감각일 것이다.",
  },
  {
    ...
    fit: "contain",
    description:
      "논문 속 공정 figure는 늘 매끈하지만 네가 실제로 마주하는 연구는 훨씬 더 느리고 거칠다. 그래서 이런 이미지는 결과의 요약이라기보다 시행착오가 하나의 형식으로 압축되는 과정을 보여주는 너 자신의 작업 일지처럼 읽힌다.",
  },
];
